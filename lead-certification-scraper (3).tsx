      ...
      <div className="bg-white rounded-lg shadow-lg max-w-xl w-full">
        ...
        <div className="bg-gray-50 px-6 py-4 rounded-b-lg border-t border-gray-200">
          <p className="text-sm text-gray-600">
            <strong>Data Source:</strong> OpenDataPhilly.org Lead Certification Database via CARTO SQL API
          </p>
          ...
          <div className="mt-2 p-2 bg-blue-50 border border-blue-200 rounded text-xs">
            <p className="text-blue-800 font-medium">CARTO SQL API Endpoint</p>
            <p className="text-blue-700">
              Now using the correct CARTO API: <span className="font-mono">phl.carto.com/api/v2/sql</span>
            </p>
          </div>
        </div>
      </div>
