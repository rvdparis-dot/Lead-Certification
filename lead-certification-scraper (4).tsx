      ...
      <div className="bg-white rounded-lg shadow-lg max-w-xl w-full">
        ...
        <div className="bg-gray-50 px-6 py-4 rounded-b-lg border-t border-gray-200">
          ...
          <div className="mt-2 p-2 bg-green-50 border border-green-200 rounded text-xs">
            <p className="text-green-800 font-medium">Verified Working Endpoint</p>
            <p className="text-green-700">
              Using the correct ArcGIS API: <span className="font-mono">services.arcgis.com/fLeGjb7u4uXqeF9q/arcgis/rest/services/lhhp_lead_certifications</span>
            </p>
          </div>
        </div>
      </div>
